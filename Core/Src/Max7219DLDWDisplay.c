...
static const uint8_t CH[12][8] = {
		...
		{0x0C, 0x3C, 0x0C, 0x0C, 0x0C, 0x0C, 0x3F, 0x00}, // 1
		{0x3C, 0xC3, 0x03, 0x0C, 0xC0, 0xC0, 0xFF, 0x00}, // 2
		{0x3C, 0xC3, 0x03, 0x3C, 0x03, 0xC3, 0x3C, 0x00}, // 3
		{0x03, 0x0F, 0x33, 0xC3, 0xFF, 0x03, 0x03, 0x00}, // 4
		{0xFF, 0xC0, 0xFC, 0x03, 0x03, 0xC3, 0x3C, 0x00}, // 5
		{0x3C, 0xC0, 0xC0, 0x3C, 0xC3, 0xC3, 0x3C, 0x00}, // 6
		{0xFF, 0x03, 0x06, 0x0C, 0x18, 0x30, 0x60, 0x00}, // 7
		{0x3C, 0xC3, 0xC3, 0x3C, 0xC3, 0xC3, 0x3C, 0x00}, // 8
		{0x3C, 0xC3, 0xC3, 0x3C, 0x03, 0x03, 0x3C, 0x00}, // 9
